                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu"
                            style="background:rgba(10,12,16,.85); backdrop-filter: blur(6px); border-radius: 16px"
                            ...
                            <li>
                                <a class="dropdown-item" href="#"><span class="menu-title">Mobile App
                                        Development</span>
                            ...
                            <li>
                                <a class="dropdown-item" href="#"><span class="menu-title">UI/UX Design</span>
                                    <div class="text-start">สร้างประสบการณ์ผู้ใช้ที่ราบรื่นและอินเทอร์เฟซที่ทันสมัย
                                    </div>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a class="dropdown-item" href="#"><span class="menu-title">Software Testing</span>
                                    <div class="text-start">ทดสอบและตรวจสอบคุณภาพซอฟต์แวร์เพื่อความเสถียรและปลอดภัย
                                    </div>
                                </a>
                            </li>
                        </ul>
        ...
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-start text-white">
                <h1 class="display-4 fw-bolder"
                    style="background: #2196F3; background: linear-gradient(to right, #2196F3 0%, #E15BED 30%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                    Learn2Code Blog</h1>
                <p class="lead fw-normal text-white-50 mb-0">รวบรวมความรู้สำหรับนักพัฒนายุคใหม่ไว้ในที่เดียว</p>
            </div>
        </div>
    </header>
    <!-- Section-->
