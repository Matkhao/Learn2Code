...
<html lang="en">
    ...
    <body>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-start text-white">
                    <h1 class="display-4 fw-bolder" style="background: #2196F3; background: linear-gradient(to right, #2196F3 0%, #E15BED 30%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Learn2Code Blog</h1>
        ...
        document.querySelectorAll('.nav-item.dropdown').forEach(function (dropdown) {
            ...
            let bsDropdown = bootstrap.Dropdown.getOrCreateInstance(toggle, { autoClose: false });
