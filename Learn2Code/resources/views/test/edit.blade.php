...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-6">
        <input type="text" class="form-control" name="phone" required placeholder="เบอร์โทร" minlength="10"  maxlength="10" value="{{ $phone }}">
        @if(isset($errors))
            @if($errors->has('phone'))
...
<div class="form-group row mb-2">
    ...
    <div class="col-sm-6">
        <input type="email" class="form-control" name="email" required placeholder="อีเมล" value="{{ $email }}">
        @if(isset($errors))
            @if($errors->has('email'))
