...
* หมายเหตุ: หากยังไม่มีข้อมูลในฐานข้อมูล ให้สร้างผู้ใช้สองรายการนี้ในตารางสมาชิก/ผู้ใช้ของคุณ
  และกำหนด is_admin = 1 สำหรับแอดมิน (หรือผูก role ให้ถูกต้อง)
...
หมายเหตุสำคัญ:
- หากใช้ guard "member" ในการล็อกอิน แต่แยกบทบาทด้วยฟิลด์ is_admin
  ควรตรวจเช็ก middleware/Policy ให้หน้าหลังบ้านเข้าถึงได้เฉพาะ is_admin = 1
- ตรวจสอบ route:list เพื่อยืนยัน URL ว่าตรงกับที่ view เรียกใช้
