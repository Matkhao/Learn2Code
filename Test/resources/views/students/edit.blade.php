    ...
    <form action="/student/{{ $id }}" method="post" enctype="multipart/form-data">
        ...
        @method('put')
         ...
         <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="std_code" required placeholder="std_code "
                    minlength="5" value="{{ $std_code }}">
                @if(isset($errors))
        ...
        <div class="form-group row mb-2">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" name="std_phone" required placeholder="เบอร์โทร"
                    minlength="10" maxlength="10" value="{{ $std_phone }}">
                @if(isset($errors))
